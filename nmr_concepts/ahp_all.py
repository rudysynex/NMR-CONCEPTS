...
def ahp_rf(
    ...
    """
    Generate an Adiabatic Half Passage pulses
    given the following parameters:
        ...
        freq_fact_k = Freq modulation factor for tanh/tan, typically 1.52
    ...
    if func == "HSn":
        ...
        # Frequency modulation
        freq_mod = np.tan(freq_fact_k * (1.0 - t_vec))
        # Normalize freq_mod to 0 to +1 range
